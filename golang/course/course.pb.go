...
func (x *CreateCourseRequest) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *GetCourseResponse) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
const file_course_course_proto_rawDesc = "" +
	"\n" +
	"\x13course/course.proto\"\xa7\x01\n" +
	...
	"\n" +
	"teacher_id\x18\x04 \x01(\x03R\tteacherId\x12\x18\n" +
	...
	"\tcourse_id\x18\x01 \x01(\x03R\bcourseId\"\xa5\x01\n" +
	...
	"\n" +
	"teacher_id\x18\x04 \x01(\x03R\tteacherId\x12\x18\n" +
	"\aversion\x18\x05 \x01(\tR\aversion2q\n" +
	"\x06Course\x127\n" +
