...
func (x *RefreshAccessTokenRequest) GetRefreshKey() string {
	if x != nil {
		return x.RefreshKey
	}
	return ""
...
func (x *RefreshAccessTokenResponse) GetAccessKey() string {
	if x != nil {
		return x.AccessKey
	}
	return ""
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\n" +
	"access_key\x18\x01 \x01(\tR\taccessKey2\xdb\x01\n" +
	"\x04Auth\x12+\n" +
	"\x06Signup\x12\x0e.SignupRequest\x1a\x0f.SignupResponse\"\x00\x12(\n" +
	"\x05Login\x12\r.LoginRequest\x1a\x0e.LoginResponse\"\x00\x12+\n" +
	"\x06Logout\x12\x0e.LogoutRequest\x1a\x0f.LogoutResponse\"\x00\x12O\n" +
	"\x12RefreshAccessToken\x12\x1a.RefreshAccessTokenRequest\x1a\x1b.RefreshAccessTokenResponse\"\x00B5Z3github.com/andicrypt/moodle-microservice-proto/authb\x06proto3"
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*RefreshAccessTokenRequest)(nil),  // 6: RefreshAccessTokenRequest
	(*RefreshAccessTokenResponse)(nil), // 7: RefreshAccessTokenResponse
}
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: Auth.Signup:input_type -> SignupRequest
	2, // 1: Auth.Login:input_type -> LoginRequest
	4, // 2: Auth.Logout:input_type -> LogoutRequest
	6, // 3: Auth.RefreshAccessToken:input_type -> RefreshAccessTokenRequest
	1, // 4: Auth.Signup:output_type -> SignupResponse
	3, // 5: Auth.Login:output_type -> LoginResponse
	5, // 6: Auth.Logout:output_type -> LogoutResponse
	7, // 7: Auth.RefreshAccessToken:output_type -> RefreshAccessTokenResponse
