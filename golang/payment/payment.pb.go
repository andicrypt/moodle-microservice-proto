...
func (x *CreatePaymentRequest) GetTotalPrice() int64 {
	if x != nil {
		return x.TotalPrice
	}
	return 0
...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\aPayment\x129\n" +
	"\x06Create\x12\x15.CreatePaymentRequest\x1a\x16.CreatePaymentResponse\"\x00B8Z6github.com/andicrypt/moodle-microservice-proto/paymentb\x06proto3"
